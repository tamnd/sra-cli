...
// HTTP behaviour is covered in sra_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "sra://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("sra", "about")
	if err != nil || got.String() != "sra://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want sra://page/about", got.String(), err)
	}
}
