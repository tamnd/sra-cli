...
Most of these come down to network reality or how sra serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sra rate-limits like any public site. sra already paces
...
Where a surface is gated, sra reads a cookie or token you supply
...
`sra`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sra actually did
